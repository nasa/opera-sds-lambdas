...
def _create_job(event: Dict):
    ...
    job_name = f"data-subscriber-download-slc-ionosphere-timer-{datetime.now(timezone.utc).strftime(JOB_NAME_DATETIME_FORMAT)}_{query_start_datetime_offset_hours}"
