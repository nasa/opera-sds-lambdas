...
class Package(setuptools.Command):
    ...
    ARCHIVE_NAME = "lambda-data-subscriber-download-slc-ionosphere-handler"
...
setuptools.setup(
    name="lambda-data-subscriber-download-slc-ionosphere-handler",
    author="PCM",
    description="Lambda package for submitting jobs that download ionosphere correction files for SLC products",
